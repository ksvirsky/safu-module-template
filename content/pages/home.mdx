...
items:
  - dashboardItems:
    ...
    _template: dashboard
  - widgetProps: >-
      {"rm-widget-type":"waitlist-widget","rm-environment":4,"rm-theme":"light-translucent","rm-subscription-type":"email","rm-waitlist-name":"","rm-title":"Insured
      deposits: Sign-up for Waitlist","rm-success-text":"Congratulations! You
      have been added to the waiting list.","rm-option1":"Smart contract hack
      risk and Oracle attack - 3%/year","rm-option2":"zkEVM availability & zkEVM
      Bridge risk - 2.5%/year","rm-option3":"Stablecoin depeg risk - USDT, USDC,
      DAI de-peg caused QLP value loss -
      3%/year","rm-option4":"","rm-option5":"","rm-address":"","rm-address-required":false,"rm-address-required-text":"","rm-email-placeholder":"","rm-telegram-button-text":"","rm-submit-button-text":""}
